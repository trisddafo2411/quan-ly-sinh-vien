						...
						<div class="col-md-5">
							...
							<div class="form-group">
								...
								<select class="form-control" id="gender" name="gender" required>
									<option value="0" value="<?=$student->gender == 0 ? "selected" : ""?>">Nam</option>
									<option value="1" value="<?=$student->gender == 0 ? "selected" : ""?>">Nữ</option>
									<option value="2" value="<?=$student->gender == 0 ? "selected" : ""?>">Khác</option>
								</select>
							</div>
							<div class="form-group">
